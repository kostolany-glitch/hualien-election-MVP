...
# 2. 定義文青風 HTML 卡片模板 (將 Claude 的精緻視覺封裝起來)
# 這裡用 Python 字串格式化，未來只要改這裡的變數，地圖與卡片就會自動更新！
html_template = """
<!DOCTYPE html>
<html lang="zh-TW">
<head>
...
# 將 Python 變數塞進網頁模板中
final_html = html_template.format(ai_report_1=ai_p1, ai_report_2=ai_p2)

# 4. 網頁外殼大標題（配合 Claude 的文青配色）
...
# 5. 一鍵渲染完全體卡片遊戲（設定高度 520px，完美自適應手機螢幕不破版）
